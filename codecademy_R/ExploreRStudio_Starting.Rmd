...
temps_f <- c(89,76,73,82,82,77,76,71)
...
possible_destinations <- list(montreal = temps_f, moscow = c(34, 35, 35, 34, 35, 34, 35), cape_town = c(87, 82, 74, 72, 71, 69, 70))
...
filter <- lapply(possible_destinations, temp_above_60)
print(filter)
```
...
library(ggplot2)
boxplot(possible_destinations, ylim=range(30:100))
```
