...
rushmore_more_freq_words = most_frequent_words(rushmore_prez_sentences)

# print(rushmore_more_freq_words)
...
rushmore_similar_to_freedom = rushmore_embeddings.most_similar('freedom', topn=10)
